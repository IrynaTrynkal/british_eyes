        ...
        ru: {
            ...
            content: [
                ...
                },
                {
                    ...
                    btn: {
                        name: "подробнее",
                        link: "/uslugi/intraokuliarnaya-korrekciya/",
                    },
                },
            ],
        },
                    ...
                    text: [
                        {
                            type: "text",
                            gap: true,
                            text: "Если вы читаете этот текст, скорее всего, вы уже знакомы с контактными линзами или очками (или и теми, и другими) не один год и слишком хорошо знаете все хлопоты и ограничения, связанные с ними. Вот что на самом деле происходит.",
                        },
                        {
                            type: "text",
                            gap: true,
                            text: "При переходе из одной среды в другую, например, из воздуха в воду, лучи света преломляются. Это называется «рефракцией». Когда лучи проходят через ткани роговицы и хрусталика, они преломляются таким образом, чтобы сфокусироваться на сетчатке. Явление, когда глаз не может сфокусировать свет на сетчатке, обычно из-за не совсем правильной формы глаза, называется нарушением рефракции.",
                        },
                        {
                            type: "text",
                            gap: true,
                            text: "Ниже кратко описаны наиболее типичные нарушения рефракции и заболевания глаз, возникновение которых связано в основном со старением и уплотнением или помутнением хрусталика, которое может происходить в пожилом возрасте.",
                        },
                    ],
                },
                {
                    ...
                    text: [
                        ...
                        },
                        {
                            type: "text",
                            gap: true,
                            text: "Близорукость (размытое видение вдали), также называемая миопией, — это наиболее частое нарушение рефракции. Обычно она возникает, когда глазное яблоко слишком длинное или роговица слишком изогнута. Избыточная длина глаза приводит к тому, что лучи света от удалённых объектов фокусируются в точке перед сетчаткой; при этом свет рассеивается, и в мозг поступает несфокусированное изображение.",
                        },
                        {
                            type: "text",
                            gap: true,
                        ...
                        },
                        {
                            type: "text",
                            gap: true,
                            text: "Дальнозоркость (то есть неспособность чётко видеть объекты вблизи) — это общепринятый термин для гиперметропии, — вызвана тем, что глазное яблоко слишком короткое или роговица слишком плоская. Из-за недостаточной длины глаза роговице и хрусталику не хватает места для пересечения лучей света в фокальной точке на сетчатке, и поэтому изображение фокусируется за сетчаткой, а в мозг снова и снова поступают искажённые сигналы.",
                        },
                        {
                            type: "text",
                            gap: true,
                        ...
                        },
                        {
                            type: "text",
                            gap: true,
                            text: "Астигматизм — дефект зрения, связанный с нарушением формы хрусталика, роговицы или глаза, в результате чего человек теряет способность к чёткому видению на любом расстоянии: и близко, и далеко. Если астигматизм не лечить, он может привести к косоглазию и резкому снижению зрения. Без коррекции астигматизм может вызывать головные боли и боль в глазах.",
                        },
                        {
                            type: "text",
                            gap: true,
                        ...
                        },
                        {
                            type: "text",
                            gap: true,
                            text: "Пресбиопия — возрастная дальнозоркость, вызванная естественным старением человека. Это аномалия рефракции глаза, при которой человек не может рассмотреть мелкий шрифт или маленькие предметы на близком расстоянии. Пресбиопия обычно начинает проявляться у людей в возрасте от 40 до 50 лет. Наиболее вероятная причина — потеря эластичности хрусталика.",
                        },
                        {
                            type: "text",
                            gap: true,
                        ...
                        },
                        {
                            type: "text",
                            gap: true,
                            text: "Вопреки распространённому мнению, катаракта — это не плёнка, которая образуется на поверхности глаза, а изменение прозрачности хрусталика внутри глаза, которое не позволяет световым лучам проходить через него. Такое постепенное помутнение со временем делает зрение менее острым. Лучи света, которым удаётся проникнуть на сетчатку, рассеиваются, и зрение становится размытым.",
                        },
                    ],
                },
            ],

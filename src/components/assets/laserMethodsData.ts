...
export const subpageCataractData: SubPageType[] = [
    {
        ...
        content: {
            uk: {
                ...
                subtitle: "безшовне видалення катаракти в складних випадках",
                data: [
                    {
                        textTitle:
            ...
            ru: {
                ...
                subtitle: "Бесшовное удаление катаракты в сложных случаях",
                data: [
                    {
                        textTitle:
            ...
            en: {
                ...
                subtitle: "Seamless cataract removal in complex cases",
                data: [
                    {
                        textTitle:

...
import { IconForPromo } from "@/components/shared/icons/IconForPromo";
...
export const HeroMain = () => {
    ...
    return (
        <>
            <section className="pc:bg-[url(/images/main-hero.jpg)] mt-12 bg-[url(/images/main-hero-tab.jpg)] bg-cover bg-top-left bg-no-repeat">
            ...
            <RunningPromo
                speed={30}
                className="bg-promo prepc:block hidden w-full"
            >

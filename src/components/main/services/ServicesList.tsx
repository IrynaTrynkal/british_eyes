                    ...
                    >
                        ...
                        <div className="tab:h-full tab:flex tab:flex-col tab:justify-between">
                            <div className="tab:flex tab:justify-between">
                                <h4
                                    className={`font-oswald tab:text-lg group-hover:text-ivory group-focus:text-ivory group-active:text-ivory pc:text-2xl pc:leading-7 tab:leading-5 leading-4 font-medium uppercase transition-colors duration-300 ease-in-out ${service.price.discountPrice ? "tab:w-[55%] w-[75%]" : "tab:w-[70%] w-full"} `}
                                >
                                ...
                                <p className="font-oswald tab:block group-hover:text-ivory group-focus:text-ivory group-active:text-ivory pc:text-base hidden text-sm leading-none uppercase transition-colors duration-300 ease-in-out">
                                    {service.price.discountPrice
                            ...
                            <div className="tab:flex tab:justify-between tab:items-end hidden w-full">
                                <p className="tab:leading-5 pc:text-lg pc:leading-[22px] group-focus:text-ivory group-hover:text-ivory group-active:text-ivory w-[80%] transition-colors duration-300 ease-in-out">
                        ...
                        >
                            <p className="font-oswald group-hover:text-ivory group-focus:text-ivory group-active:text-ivory text-sm leading-none uppercase transition-colors duration-300 ease-in-out">
                                {service.price.discountPrice
                                    ? t("servicesDiscountPrice", {

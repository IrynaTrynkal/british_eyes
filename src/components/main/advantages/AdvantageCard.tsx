...
export const AdvantageCard = ({
    ...
    return (
        ...
        >
            ...
            <div className="pc:w-[295px] relative z-[1] mx-auto w-[204px]">
                <h4
                ...
                <p
                    className={`pc:text-lg pc:leading-[21.2px] text-sm leading-4 ${ind === 5 && "mx-auto text-center"} ${ind === 2 && "backdrop-blur-xs"}`}
                >
                    {text}
                </p>
            </div>

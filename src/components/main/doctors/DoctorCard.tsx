...
export const DoctorCard = ({ data }: { data: DoctorProps }) => {
    ...
    return (
        <div className="group tab:h-[420px] pc:h-[520px] h-[374px] overflow-hidden rounded-sm bg-white/10">
            <div className="tab:w-[250px] tab:h-[250px] pc:w-[321px] pc:h-[321px] h-[220px] w-[220px] overflow-hidden rounded-sm">
                <Image
                    src={photo}
            ...
            <div className="tab:pt-3 tab:h-[170px] pc:h-[190px] flex h-[154px] flex-col justify-between pt-2">
                <div className="tab:px-3 pc:mb-0 mb-2 px-2">
                    <p className="font-oswald text-ivory pc:mb-2 mb-1 text-sm leading-none uppercase opacity-80">
                        {t("experienceSince", { year: year })}
                    </p>
                    <p className="font-oswald text-ivory pc:mb-2 tab:text-xl pc:text-2xl pc:leading-7 tab:leading-6 mb-1 leading-5 font-medium uppercase">
                        {data[locale as LocaleType].name}
                    </p>
                    <p className="text-ivory pc:[display:-webkit-box] pc:text-base pc:leading-5 line-clamp-3 overflow-hidden text-sm leading-4 break-words opacity-80">

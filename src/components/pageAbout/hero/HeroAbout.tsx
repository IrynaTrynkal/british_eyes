...
export const HeroAbout = () => {
    ...
    return (
        <section className="tab:mt-0 tab:h-120 prepc:h-[552px] prepc:bg-bottom relative mt-12 h-[calc(60vh-48px)] bg-[url(/images/about-hero.jpg)] bg-cover bg-center bg-no-repeat">

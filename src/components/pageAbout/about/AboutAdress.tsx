...
export const AboutAdress = ({ className }: { className?: string }) => {
    const t = useTranslations("HomePage");
    return (
        <div
            className={`group tab:w-[220px] tab:p-3 w-[174px] rounded-sm bg-white/10 px-2 py-1 backdrop-blur-sm ${className}`}
        >
            <a
                href={gogleMapLink}
                target="_blank"

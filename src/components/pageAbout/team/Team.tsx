            ...
            <ul className="tab:flex-row tab:flex-wrap tab:justify-center prepc:gap-5 tab:mb-0 mb-6 flex flex-col gap-3">
                {aboutServicesList.map(ser => {
                    ...
                    return (
                        <li
                            key={ser.key}
                            className="border-grey tab:max-w-[480px] prepc:w-[32%] prepc:max-w-[434px] group hover-green-gradient pc:w-[434px] tab:w-[49%] overflow-hidden rounded-xl border p-3"
                        >

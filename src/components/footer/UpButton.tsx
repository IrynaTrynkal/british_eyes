    ...
    return (
        <div className="group relative">
            <button
                ...
                className={` ${className} tab:h-8 tab:w-8 prepc:h-11 prepc:w-11 bg-ivory group border-ivory tab:rounded-sm flex h-6 w-6 items-center justify-center rounded-xs border transition-colors duration-300 ease-in-out group-hover:bg-black`}
                onClick={() => {
                    window.scrollTo({
                        top: 0,
                        behavior: "smooth",

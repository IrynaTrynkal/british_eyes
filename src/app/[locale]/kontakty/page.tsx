...
import {
    ...
    gogleMapLink,
    hotLineNumber,
} from "@/components/assets/contacts";
import { Booking } from "@/components/shared/booking/Booking";
import { GreenText } from "@/components/shared/GreenText";
import { IconArrow } from "@/components/shared/icons/IconArrow";
import { IconInvalid } from "@/components/shared/icons/IconInvalid";
import { IconNoParking } from "@/components/shared/icons/IconNoParking";
import { PhoneNumberList } from "@/components/shared/PhoneNumberList";
    ...
    return (
        <>
            <section className="tab:flex tab:py-12 pc:pb-[120px] prepc:pt-[72px] tab:flex-row-reverse tab:gap-4 tab:items-stretch">
                <div className="tab:mt-0 tab:min-h-full tab:w-[calc(50%-8px)] pc:min-h-[1010px] pc:max-h-[1010px] relative mt-12 h-[calc(100vh-48px)] bg-[url(/images/contact-hero.jpg)] bg-cover bg-bottom bg-no-repeat"></div>
                <div className="tab:max-w-full tab:w-[calc(50%-8px)] tab:pt-4 tab:pr-0 prepc:pt-8 prepc:pl-6 pc:pl-12 tab:pb-0 mx-auto max-w-[540px] px-4 py-[60px]">
